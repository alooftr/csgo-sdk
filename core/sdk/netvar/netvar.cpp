...
// used: game_interfaces
#include "../csgo.h"

#include "../../utilities/utilities.h"

bool c_netvar_manager::setup( const char* file_name )
{
	// clear values
	map_props.clear( );
	stored_props = 0;
	...
	for ( auto class_pointer = g_game_interfaces->client->get_all_classes( ); class_pointer != nullptr; class_pointer = class_pointer->next )
	{
