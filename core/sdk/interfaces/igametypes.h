...
public:
	...
	{
		return c_memory::call_vfunc<int>( this, 8 );
	}

	int get_current_game_mode( )
	{
		return c_memory::call_vfunc<int>( this, 9 );
	}

	const char* get_current_map_name( )
	{
		return c_memory::call_vfunc<const char*>( this, 10 );
	}

	const char* get_current_game_type_name_id( )
	{
		return c_memory::call_vfunc<const char*>( this, 11 );
	}

	const char* get_current_game_mode_name_id( )
	{
		return c_memory::call_vfunc<const char*>( this, 13 );
	}
};
