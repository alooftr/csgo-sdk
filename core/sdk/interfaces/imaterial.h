#pragma once
#include "../data_types/key_value.h"
...
public:
	...
	{
		return c_memory::call_vfunc<i_texture*>( this, 1 );
	}

	void set_float( float value )
	{
		c_memory::call_vfunc<void>( this, 4, value );
	}

	void set_int( int value )
	{
		c_memory::call_vfunc<void>( this, 5, value );
	}

	void set_string( const char* value )
	{
		c_memory::call_vfunc<void>( this, 6, value );
	}

	void set_vector( float x, float y )
	{
		c_memory::call_vfunc<void>( this, 10, x, y );
	}

	void set_vector( float x, float y, float z )
	{
		c_memory::call_vfunc<void>( this, 11, x, y, z );
	}

	void set_texture( i_texture* pTexture )
	{
		c_memory::call_vfunc<void>( this, 15, pTexture );
	}

	void set_vector_component( float value, int component )
	{
		c_memory::call_vfunc<void>( this, 26, value, component );
	}
};
...
public:
	...
	virtual e_preview_image_ret_val get_preview_image_properties( int* width, int* height, e_image_format* image_format, bool* translucent ) const = 0;
	virtual e_preview_image_ret_val get_preview_image( unsigned char* pData, int width, int height, e_image_format image_format ) const = 0;
	...
	virtual i_material_var* find_var( const char* name, bool* found = nullptr, bool complain = true ) = 0;
	...
	virtual i_material_var* find_var_fast( char const* name, unsigned int* token ) = 0;
