...
public:
	...
	virtual void			register_con_command( c_convar* cmd_base, int default_value = 1 ) = 0;
	virtual void			unregister_con_command( c_convar* cmd_base ) = 0;
	...
	virtual c_convar* find_var( const char* variable_name ) = 0;
	virtual const c_convar* find_var( const char* variable_name ) const = 0;
	virtual c_concmd* find_com_mand( const char* name ) = 0;
	...
	virtual void			call_global_change_callbacks( c_convar* var, const char* old_string, float old_value ) = 0;
	...
	virtual void			console_color_printf( const col_t& col_t, const char* format, ... ) const = 0;
