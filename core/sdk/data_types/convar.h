...
public:
	const char* get_name( )
	{
		return c_memory::call_vfunc<const char*>( this, 5 );
	}

	float get_float( ) // idx @ 11
	{
		std::uint32_t xored = *reinterpret_cast< std::uint32_t* >( &parent->value_float ) ^ reinterpret_cast< std::uint32_t >( this );
	...
	{
		return c_memory::call_vfunc<void>( this, 14, v );
	}

	void set_value( float v )
	{
		return c_memory::call_vfunc<void>( this, 15, v );
	}

	void set_value( int v )
	{
		return c_memory::call_vfunc<void>( this, 16, v );
	}

	void set_value( col_t v )
	{
		return c_memory::call_vfunc<void>( this, 17, v );
	}
