...
#define xor_str( s ) s
#else
#define xor_str( s ) jm::make_xorstr([]() { return s; }, std::make_index_sequence<sizeof( s ) / sizeof( *s )>{}, std::make_index_sequence<jm::detail::_buffer_size<sizeof( s )>()>{})
#define xor_str( s ) xor_str( s ).crypt_get()
#endif
